  ...
  <PageSection class="section v3 shadowFromTop" id="apply">
    ...
    <div class="contentcolumn">
      ...
      <div class="columns">
        ...
        <div class="studio">
          <h2 v-if="locale === 'ja'">シェアスタジオ</h2>
          <h2 v-else>Shared Studio</h2>
          <div>
            <template v-if="locale === 'ja'">
              洋館部分の2階は、シェアスタジオとして月単位で入居頂けます。オープンスタジオを定期的に開催し、地域に開いたシェアスタジオとなる予定です。
              <ul>
                <li>1区画 3×2.6m程度、計3~4区画</li>
                <li>
          ...
          <div>
            <template v-if="locale === 'ja'">
              ...
              <div>
                <ul>
                  <li>
                    建築、都市デザイン・プランニング、市民参加、コミュニティマネジメント、不動産、都市に関するテーマで活動を行うジャーナリズム、アートなどに関わる活動を対象とします
                  </li>
                  <li>
