        ...
        <div class="flex text3">
          <div class="textbox left">
            <template v-if="locale === 'ja'">
              ...
              <p>
                Bridge to
                Kyotoは、建築や街づくりに関わるアーバニストや、都市や公共空間をテーマに活動を行うアーティストが1〜6ヶ月の期間で滞在して活動できるアーバニスト・イン・レジデンスとして機能してきました。2023年3月からは、建築・都市・まちづくり関係の蔵書やアイテムを公開する私設ライブラリーとして、不定期でオープンしています（日程は
                <a
